		...
		<div class="row">
			<div class="col-xl-3 col-lg-4 col-md-5">
				<div class="sidebar-categories">
					<jsp:useBean id="productosSearch" type="java.util.List<g16.model.Producto>" scope="request" />
					<jsp:useBean id="productosSearchCategory" type="java.util.List<java.util.List<g16.model.Producto>>" scope="request" />
					<jsp:useBean id="category" type="java.lang.String" scope="request" />
					<%
                    List <List<Producto>> productosCategoria = productosSearchCategory;
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<section class="lattest-product-area pb-40 category-list">
					<h3>Results for your search: <% out.print("'" + session.getAttribute("busqueda") + "'"); %></h3>
					<div class="row">
                    ...
                    if(category == "") productos = productosSearch; 
                    else productos = productosCategoria.get(categories.indexOf(category)); %>
