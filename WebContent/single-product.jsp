...
<body>
	...
	<!--================Single Product Area =================-->
	<jsp:useBean id="productoShow" type="g16.model.Producto" scope="request" />
	<% Usuario vendedor = productoShow.getVendedor(); %>
	<div class="product_image_area">
		<div class="container">
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<img src= <% out.print("'" + "data:image/jpeg;base64," +  productoShow.getImagen() + "'"); %> style="width: 80%" name="foto" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Imagen'">
                </div>
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<form METHOD=POST ACTION="addtocart">
							<input type="hidden" name="Id" value = <% out.print(productoShow.getIdproduct()); %> readonly>
							<h3><% out.print(productoShow.getTitulo()); %></h3>
							<h2><% out.print(productoShow.getPrecio() + " euros"); %></h2>
							<ul class="list">
								<li><a class="active" href="#"><span>Category</span> : <% out.print(productoShow.getCategoria()); %></a></li>
								<li><a href="#"><span>Availibility</span> : <% out.print(productoShow.getEstado()); %></a></li>
								<li><a href="#"><span>Seller</span> : <% out.print(vendedor.getEmail()); %></a></li>
							</ul>
							<p><% out.print(productoShow.getDescripcion()); %></p>
							
							<% if(productoShow.getEstado().equals("Disponible") && !vendedor.getEmail().equals(session.getAttribute("email"))) { %>
						...
						<form METHOD=POST ACTION="showsendmessage">
							<input type="hidden" name="emailSeller" value = <% out.print(vendedor.getEmail()); %> readonly>
							<div class="col-md-12 form-group">
