			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<jsp:useBean id="productoEdit" type="g16.model.Producto" scope="request" />
						<form class="row login_form" METHOD=POST ACTION="modifyproduct" enctype="multipart/form-data">							
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="titulo" placeholder="Título" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Título'" required value = <% out.print("'" + (String)productoEdit.getTitulo() + "'"); %>>
							</div>
							<div class="col-md-12 form-group">
								<select name="categoria" id="cars">
									<option value="abrigo"><% out.print(productoEdit.getCategoria()); %></option>
                            ...
                            <div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="descripcion" placeholder="Descripción" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Descripción'" required value = <% out.print("'" + (String)productoEdit.getDescripcion() + "'"); %>>
							</div>
							<div class="col-md-12 form-group">
								<img src= <% out.print("'" + "data:image/jpeg;base64," + productoEdit.getImagen() + "'"); %> style="width: 80%" name="foto" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Imagen'">
							</div>
							<div class="col-md-12 form-group">
                            ...
                            <div class="col-md-12 form-group">
								<input type='number' min="0" step='1' value=<%out.print("'" + productoEdit.getPrecio() + "'"); %> placeholder='0' name="precio" pattern="^\d*(\.\d{0,2})?$" placeholder="Precio" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Precio'">euros
							</div>
							<div class="col-md-12 form-group">
